...
const URL_FAV_LIST = 'https://api.bilibili.com/x/v3/fav/resource/ids?media_id={mid}';

const URL_FAV_LIST_OLD =
...
export const fetchFavList = async (
  ...
  const BVidPromises = bvids.map((val, i) => fetchVideoInfo(val, () => {
