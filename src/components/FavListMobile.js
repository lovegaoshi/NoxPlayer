import React, {
  forwardRef, useEffect, useState, useCallback, memo, useContext,
} from 'react';
  ...
  const favListComponent = () => {
    return (
      <Box // Mid Grid -- SideBar
        ...
        style={{
          overflow: 'auto', height: 'calc(100% - 52px)', paddingTop: '10px', lineHeight: '24px',
        }}
        sx={{ gridArea: 'sidebar' }}
      >
  ...
  const favComponent = () => {
    return (
      <Box // Mid Grid -- Fav Detail
        style={{
          height: 'calc(100% - 86px)', maxHeight: 'calc(100% - 86px)', paddingLeft: '20px', overflow: 'auto',
        }}
