...
export const skins = (key = setting.skin) => {
    ...
    switch (key) {
        case 'clessS': 
            return {
                playerBanner: 'https://raw.githubusercontent.com/lovegaoshi/azusa-player/nox-player/public/img/clessS/banner.png',
                playerBannerMobile: 'https://raw.githubusercontent.com/lovegaoshi/azusa-player/nox-player/public/img/clessS/mobilebanner.png',
                gifIcon: () => {
                    let gifs = [
