  ...
  skinTemplate({
    ...
    playerBannerMobile: async () =>
      new Promise<string>((resolve) => {
        resolve(
          'http://150.158.139.227:9527/getimg?imgserve=itsuki&file=Itsukibgm.png',
        );
      }),
    ...
    gifs,
    gifIcon: () => {
      return 'http://150.158.139.227:9527/getimg?imgserve=itsuki&file=ItsukiRandomGIF/Itsuki{count}.gif'.replace(
        '{count}',
